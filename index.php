...
<!-- llamamoa a la base de datos conexion -->
<?php
	session_start();
   require_once "conexion_MySql/conexion.php";  /*asignamos la carpeta donde esta nuestra conexion*/
	$conexion=conexion();  /*hacemos referencia de variable a la conexion*/
?>
<!doctype html>
